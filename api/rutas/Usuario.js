...
var usuario_controlador = __importStar(require("../controladores/usuario"));
exports.usuario_router = express_1.Router();
exports.usuario_router.post('/usuario', usuario_controlador.crearUsuario);
exports.usuario_router.post('/usuario/find', usuario_controlador.encontrarUsuarioVyNomOApe);
